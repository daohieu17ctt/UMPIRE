...
QUES_FILE='/home/daohieu/maplecg_nfs/research/VLM/su_vlm/data/vqav2/llava_OpenEnded_mscoco_val2014_questions_3k.jsonl' # preprocessed question file
...
#         --temperature 1 \
#         --top_p='0.9' \
#         --num_generations_per_prompt=50 &> $OUTDIR/logs/generation_embedding_${SPLIT}_${CKPT}_${CHUNKS}_${IDX}_output.log &
# done
